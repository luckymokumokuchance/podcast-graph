// ============================================================
// ラッキーもくもくチャンス - INSPIRED（本/映画/アニメ・ドラマ/音楽/ラジオ 一覧）
// GASの ?type=works を唯一のデータソースとして使う。
...
// ▲ テスト時は inspired.html?src=mock.json のように差し替え可能。無指定なら works エンドポイント。
const _src = new URLSearchParams(location.search).get('src');
const DATA_URL = _src || (GAS_URL + '?type=works');
...
// ------------------------------------------------------------
// 検索用の正規化（episodes.js / concepts.js と同一）
// ------------------------------------------------------------
