// ============================================================
// ラッキーもくもくチャンス - LOG一覧＆検索（app/版）
// ルート直下の log.js との違いは取得元だけ：
//   root : GAS Web App を ?type=logs で直接叩く（都度2秒前後かかる）
//   app  : logs.json（GitHub Actionsが定期同期する静的ファイル）を読む
// 表示・検索まわりのロジックは同じ。
// ============================================================

const LOGS_URL = 'logs.json';
